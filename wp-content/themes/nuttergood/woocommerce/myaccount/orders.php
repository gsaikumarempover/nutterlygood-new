<?php
/**
 * Orders — Farmley layout with wrapped action buttons.
 *
...
<?php if ( $has_orders ) : ?>
	...
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table ng-farmley-orders-table">
		<colgroup>
			<col class="ng-farmley-orders-table__col ng-farmley-orders-table__col--order" />
			<col class="ng-farmley-orders-table__col ng-farmley-orders-table__col--date" />
			<col class="ng-farmley-orders-table__col ng-farmley-orders-table__col--status" />
			<col class="ng-farmley-orders-table__col ng-farmley-orders-table__col--total" />
			<col class="ng-farmley-orders-table__col ng-farmley-orders-table__col--actions" />
		</colgroup>
		<thead>
			<tr>
					...
					<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) :
						...
						<?php endif; ?>
							...
							<?php if ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									echo '<div class="ng-farmley-order-actions">';
									foreach ( $actions as $key => $action ) {
										...
										echo '<a href="' . esc_url( $action['url'] ) . '" class="woocommerce-button' . esc_attr( $wp_button_class ) . ' button ng-farmley-order-actions__btn ' . esc_attr( $key ) . '" aria-label="' . esc_attr( $action_aria_label ) . '">' . esc_html( $action['name'] ) . '</a>';
							...
							<?php elseif ( has_action( 'woocommerce_my_account_my_orders_column_' . $column_id ) ) : ?>
