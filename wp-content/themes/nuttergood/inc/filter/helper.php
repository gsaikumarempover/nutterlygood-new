...
if ( ! function_exists( 'greenpath_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function greenpath_get_filter_items( $params ) {
		...
		return apply_filters( 'greenpath_filter_get_filter_items', $items, $params );
	}
}
