...
abstract class Qode_Compare_For_WooCommerce_Framework_Page implements Qode_Compare_For_WooCommerce_Framework_Tree_Interface {
	private $scope;
	private $type;
	private $slug;
	private $layout;
	...
	public function render() {
		...
		$params['class']      .= ' qodef-page-v4-compare';

		if ( $this->get_layout() === 'tabbed' ) {
			wp_enqueue_script( 'jquery-ui-tabs' );
		}

		qode_compare_for_woocommerce_framework_template_part( QODE_COMPARE_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/page', $this->get_layout(), $params );
	}
}
