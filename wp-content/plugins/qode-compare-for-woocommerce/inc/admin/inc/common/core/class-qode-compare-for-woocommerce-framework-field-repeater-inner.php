...
class Qode_Compare_For_WooCommerce_Framework_Field_Repeater_Inner implements Qode_Compare_For_WooCommerce_Framework_Tree_Interface, Qode_Compare_For_WooCommerce_Framework_Child_Interface {
								...
								<div class="qodef-repeater-inner-fields-holder qodef-second-level clearfix" data-index="<?php echo esc_attr( $counter ); ?>">
									...
									<div class="qodef-repeater-actions-holder">
										...
										<div class="qodef-repeater-remove">
											<a class="qodef-clone-inner-remove" href="#" rel="noopener noreferrer"><?php qode_compare_for_woocommerce_framework_svg_icon( 'trash' ); ?></a>
										</div>
									</div>
								</div>
								<?php
