...
abstract class Qode_Compare_For_WooCommerce_Framework_Tab implements Qode_Compare_For_WooCommerce_Framework_Tree_Interface, Qode_Compare_For_WooCommerce_Framework_Child_Interface {
	private $scope;
	private $type;
	private $name;
	private $title;
	...
	public function render() {
		...
		qode_compare_for_woocommerce_framework_template_part( QODE_COMPARE_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/tab', '', $params );
	}
}
