...
?>
<div class="qodef-section-wrapper qodef-welcome-section col-12 <?php echo esc_attr( $class ); ?>" <?php qode_compare_for_woocommerce_inline_attrs( $dependency_data, true ); ?>>
