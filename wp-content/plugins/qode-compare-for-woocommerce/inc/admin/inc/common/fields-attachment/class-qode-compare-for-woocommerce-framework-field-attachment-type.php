...
abstract class Qode_Compare_For_WooCommerce_Framework_Field_Attachment_Type {
	...
	public function __construct( $params ) {
		...
		$value           = qode_compare_for_woocommerce_framework_get_option_value( '', $this->type, $this->name, $this->default_value, $this->post_id );
		$params['value'] = $value;
