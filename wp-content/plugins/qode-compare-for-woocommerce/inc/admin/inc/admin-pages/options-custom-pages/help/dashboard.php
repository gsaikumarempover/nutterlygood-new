...
if ( ! function_exists( 'qode_compare_for_woocommerce_add_help_custom_options_page' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function qode_compare_for_woocommerce_add_help_custom_options_page() {
		$custom_page = Qode_Compare_For_WooCommerce_Admin_Options_Custom_Page_Handler::get_instance();

		$custom_page->add_page(
			array(
				'slug'     => 'help',
				'title'    => esc_html__( 'Help', 'qode-compare-for-woocommerce' ),
				'position' => 2,
				'script'   => false,
	...
	add_action( 'init', 'qode_compare_for_woocommerce_add_help_custom_options_page', 9 );
}
