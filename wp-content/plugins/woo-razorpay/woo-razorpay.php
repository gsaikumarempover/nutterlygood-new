...
EOT;
    ...
    {
        $settings = rzp_get_wc_settings();

        if (empty($settings['key_id']) === true or empty($settings['key_secret']) === true)
        {
            return;
        }
            ...
            get_option('rzp_afd_enable') === 'yes')
        {
                ...
                get_option('rzp_afd_feature_checked') === 'no')
            {
                try
                {
                    ...
                    $api      = new Api($keyId, $settings['key_secret']);
    ...
    function trigger_rtb_widget()
    {
            ...
            get_option('rzp_rtb_feature_checked') === 'no')
        {
            try
            {
                $api = new Api($key_id, $settings['key_secret']);
        ...
        if (empty($settings) === false and
            isset($settings['enable_rtb_widget']) === true and
            $settings['enable_rtb_widget'] === 'yes' and
