...
if ( ! class_exists( 'GreenPathCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class GreenPathCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'greenpath_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return GreenPathCore_Dashboard_Rest_API
		 */
	...
	GreenPathCore_Dashboard_Rest_API::get_instance();
}
