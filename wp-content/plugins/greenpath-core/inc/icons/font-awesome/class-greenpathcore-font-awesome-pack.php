...
if ( ! function_exists( 'greenpath_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function greenpath_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'GreenPathCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'greenpath_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class GreenPathCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return GREENPATH_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		private function icons_array() {
			return array_flip(
				array(
					...
					"Bluetooth Alt"                              => "fab fa-bluetooth-b",
					"Bold"                                       => "fa fa-bold",
					"Bolt"                                       => "fa fa-bolt",
					...
					"Twitter Square"                             => "fab fa-square-twitter",
		...
		function specific_icons() {
			return apply_filters(
				'greenpath_core_filter_font_awesome_specific_icons',
				array(
					'search'        => 'fa fa-search',
		...
		function get_new_icons_list() {
			...
			if ( file_exists( GREENPATH_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( GREENPATH_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
