...
if ( ! function_exists( 'greenpath_core_nav_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function greenpath_core_nav_menu_options( $page ) {
		...
		if ( $page ) {
			$main_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Main Menu Settings', 'greenpath-core' ),
				)
			);
			...
			$section = $main_menu_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Main Menu', 'greenpath-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Dropdown Position', 'greenpath-core' ),
					'description' => esc_html__( 'Enter value in percentage of entire header height', 'greenpath-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Dropdown Background Color', 'greenpath-core' ),
					'description' => esc_html__( 'Set header menu dropdown color', 'greenpath-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Main Menu Dropdown Appearance', 'greenpath-core' ),
					'default_value' => 'default',
					'options'       => array(
						'default'        => esc_html__( 'Default', 'greenpath-core' ),
						'animate-height' => esc_html__( 'Animate Height', 'greenpath-core' ),
					),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Full Width', 'greenpath-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Wide Dropdown Background Color', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 4,
					),
				)
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Content In Grid', 'greenpath-core' ),
					'default_value' => 'yes',
					'args'          => array(
						'col_width' => 4,
					),
			...
			$nav_menu_typography_section = $main_menu_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Main Menu Typography', 'greenpath-core' ),
				)
			);
			...
			$first_level_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu First Level Typography', 'greenpath-core' ),
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Active Color', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover/Active Text Decoration', 'greenpath-core' ),
					'options'    => greenpath_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Left/Right', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Padding Left/Right', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$second_level_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Typography', 'greenpath-core' ),
				)
			);
			...
			$second_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Wide Typography', 'greenpath-core' ),
				)
			);
			...
			$third_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Third Level Wide Typography', 'greenpath-core' ),
				)
			);
	...
	add_action( 'greenpath_core_action_after_header_options_map', 'greenpath_core_nav_menu_options' );
}
