...
if ( ! class_exists( 'GreenPathCore_Shortcodes' ) ) {
	class GreenPathCore_Shortcodes {
		...
		/**
		 * @return GreenPathCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once GREENPATH_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once GREENPATH_CORE_SHORTCODES_PATH . '/class-greenpathcore-shortcode.php';
			include_once GREENPATH_CORE_SHORTCODES_PATH . '/class-greenpathcore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'greenpath_core_filter_register_shortcodes', array() );
	...
	GreenPathCore_Shortcodes::get_instance();
}
