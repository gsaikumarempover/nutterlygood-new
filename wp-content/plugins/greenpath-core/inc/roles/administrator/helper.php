...
if ( ! function_exists( 'greenpath_core_add_administrator_role_caps' ) ) {
	/**
	 * Function that add user role capabilities for custom post types
	 */
	function greenpath_core_add_administrator_role_caps() {

		// Add the roles you'd like to administer the custom post types
		$roles = apply_filters( 'greenpath_core_filter_administrator_roles', array( 'editor', 'administrator' ) );

		// Allowed custom post types
		$cpt_items = apply_filters( 'greenpath_core_filter_administrator_cpts', array() );
	...
	add_action( 'greenpath_core_action_plugin_loaded', 'greenpath_core_add_administrator_role_caps' );
}
