<div class="qodef-m-inner">
	<div class="qodef-m-weather">
		...
		<?php greenpath_core_template_part( 'widgets/weather', 'templates/parts/temperature', '', $params ); ?>
	</div>
	<div class="qodef-m-weather-info qodef-e">
		...
		<p class="qodef-e-humidity">
			<?php echo sprintf( '%s%s%s', esc_html__( 'Humidity:', 'greenpath-core' ), esc_html( $today_humidity ), esc_html__( '%', 'greenpath-core' ) ); ?>
		</p>
		<p class="qodef-e-wind">
			<?php echo sprintf( '%s%s%s', esc_html__( 'Wind:', 'greenpath-core' ), esc_html( $today_wind_speed ), esc_html( $wind_unit ) ); ?>
		</p>
