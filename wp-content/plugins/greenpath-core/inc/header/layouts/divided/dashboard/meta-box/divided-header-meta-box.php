...
if ( ! function_exists( 'greenpath_core_add_divided_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function greenpath_core_add_divided_header_meta( $page ) {
	...
	add_action( 'greenpath_core_action_after_page_header_meta_map', 'greenpath_core_add_divided_header_meta' );
}
