...
class GreenPathCore_Standard_Header extends GreenPathCore_Header {
	...
	/**
	 * @return GreenPathCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return greenpath_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
