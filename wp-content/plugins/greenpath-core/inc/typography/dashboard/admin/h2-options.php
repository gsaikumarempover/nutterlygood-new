...
if ( ! function_exists( 'greenpath_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function greenpath_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'greenpath-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'greenpath-core' ),
				)
			);
	...
	add_action( 'greenpath_core_action_after_typography_options_map', 'greenpath_core_add_h2_typography_options' );
}
