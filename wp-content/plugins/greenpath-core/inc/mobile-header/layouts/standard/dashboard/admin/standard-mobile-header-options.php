...
if ( ! function_exists( 'greenpath_core_add_standard_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function greenpath_core_add_standard_mobile_header_options( $page, $general_tab ) {

		$section = $general_tab->add_section_element(
			array(
				'name'       => 'qodef_standard_mobile_header_section',
				'title'      => esc_html__( 'Standard Mobile Header', 'greenpath-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'greenpath_core_action_after_mobile_header_options_map', 'greenpath_core_add_standard_mobile_header_options', 10, 2 );
}
