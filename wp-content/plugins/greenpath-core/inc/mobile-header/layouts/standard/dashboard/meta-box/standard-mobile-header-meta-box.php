...
if ( ! function_exists( 'greenpath_core_add_standard_mobile_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function greenpath_core_add_standard_mobile_header_meta( $page ) {
	...
	add_action( 'greenpath_core_action_after_page_mobile_header_meta_map', 'greenpath_core_add_standard_mobile_header_meta', 10, 2 );
}
