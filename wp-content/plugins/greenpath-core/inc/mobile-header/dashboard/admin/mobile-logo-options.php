...
if ( ! function_exists( 'greenpath_core_add_mobile_logo_options' ) ) {
	/**
	 ...
	 */
	function greenpath_core_add_mobile_logo_options( $page, $mobile_header_tab ) {
		...
		if ( $page ) {
			...
			$mobile_header_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Mobile Header Logo Options', 'greenpath-core' ),
					'description' => esc_html__( 'Set options for mobile headers', 'greenpath-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Height', 'greenpath-core' ),
					'description' => esc_html__( 'Enter mobile logo height', 'greenpath-core' ),
					'args'        => array(
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Padding', 'greenpath-core' ),
					'description' => esc_html__( 'Enter mobile logo padding value (top right bottom left)', 'greenpath-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo Source', 'greenpath-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					'field_type'    => 'yesno',
					'name'          => 'qodef_mobile_logo_predefined_icon',
					'title'         => esc_html__( 'Mobile Logo - Predefined animated icon before logo', 'greenpath-core' ),
					'default_value' => 'no',
				)
			);
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo - Main', 'greenpath-core' ),
					'description'   => esc_html__( 'Choose main mobile logo image', 'greenpath-core' ),
			...
			do_action( 'greenpath_core_action_after_mobile_logo_image_section_options_map', $page, $mobile_header_tab, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'greenpath_core_action_after_mobile_logo_svg_path_section_options_map', $page, $mobile_header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'greenpath_core_action_after_mobile_logo_textual_section_options_map', $page, $mobile_header_tab, $logo_textual_section );

			do_action( 'greenpath_core_action_after_mobile_logo_options_map', $page );
		}
	}

	add_action( 'greenpath_core_action_after_header_logo_options_map', 'greenpath_core_add_mobile_logo_options', 10, 2 );
}
