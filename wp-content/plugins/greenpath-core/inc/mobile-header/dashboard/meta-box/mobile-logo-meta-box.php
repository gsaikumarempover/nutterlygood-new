...
if ( ! function_exists( 'greenpath_core_add_page_mobile_logo_meta_box' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function greenpath_core_add_page_mobile_logo_meta_box( $logo_tab ) {
		...
		if ( $logo_tab ) {
			...
			do_action( 'greenpath_core_action_after_mobile_logo_image_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'greenpath_core_action_after_mobile_logo_svg_path_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'greenpath_core_action_after_mobile_logo_textual_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'greenpath_core_action_after_page_mobile_logo_meta_map', $mobile_header_logo_section );
		}
	}

	add_action( 'greenpath_core_action_after_page_mobile_header_meta_map', 'greenpath_core_add_page_mobile_logo_meta_box' );
}
