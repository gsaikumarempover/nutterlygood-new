	...
	<div class="qodef-e-inner">
		<?php if ( has_post_thumbnail() ) { ?>
			<div class="qodef-e-media">
				<?php
				$params['list_image_dimension'] = 'custom';
				$params['custom_image_height']  = 239;
		...
		<div class="qodef-e-content">
			...
			<?php greenpath_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/excerpt', '', $params ); ?>
