...
if ( ! function_exists( 'greenpath_core_add_product_list_variation_info_below' ) ) {
	/**
	 ...
	 * @return array
	 */
	function greenpath_core_add_product_list_variation_info_below( $variations ) {
		$variations['info-below'] = esc_html__( 'Info Below', 'greenpath-core' );

		return $variations;
	}

	add_filter( 'greenpath_core_filter_product_list_layouts', 'greenpath_core_add_product_list_variation_info_below' );
}

if ( ! function_exists( 'greenpath_core_register_shop_list_info_below_actions' ) ) {
	/**
	 * Function that override product item layout for current variation type
	 */
	function greenpath_core_register_shop_list_info_below_actions() {
	...
	add_action( 'greenpath_core_action_shop_list_item_layout_info-below', 'greenpath_core_register_shop_list_info_below_actions' );
}
