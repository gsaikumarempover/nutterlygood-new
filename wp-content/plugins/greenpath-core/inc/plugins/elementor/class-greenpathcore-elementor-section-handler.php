...
class GreenPathCore_Elementor_Section_Handler {
	...
	/**
	 * @return GreenPathCore_Elementor_Section_Handler
	 */
	...
	public function render_background_text_options( $column, $args ) {
		$column->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Nutterlygood Core Background Text', 'greenpath-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Enable Background Text', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'no',
				'options'     => array(
					'no'  => esc_html__( 'No', 'greenpath-core' ),
					'yes' => esc_html__( 'Yes', 'greenpath-core' ),
				),
				'render_type' => 'template',
			)
		);
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Color', 'greenpath-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1512 and 1369 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1368 and 1201 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - from 1200 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1512 and 1369 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1368 and 1201 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - from 1200 (px)', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Horizontal Align', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Left', 'greenpath-core' ),
					'center'     => esc_html__( 'Center', 'greenpath-core' ),
					'flex-end'   => esc_html__( 'Right', 'greenpath-core' ),
				),
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Align', 'greenpath-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Top', 'greenpath-core' ),
					'center'     => esc_html__( 'Middle', 'greenpath-core' ),
...
if ( ! function_exists( 'greenpath_core_init_elementor_section_handler' ) ) {
	/**
	 * Function that initialize main page builder handler
	 */
	function greenpath_core_init_elementor_section_handler() {
		GreenPathCore_Elementor_Section_Handler::get_instance();
	}

	add_action( 'init', 'greenpath_core_init_elementor_section_handler', 1 );
}
