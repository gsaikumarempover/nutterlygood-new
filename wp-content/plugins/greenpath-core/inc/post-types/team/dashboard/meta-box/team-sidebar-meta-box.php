...
if ( ! function_exists( 'greenpath_core_add_team_single_sidebar_meta_boxes' ) ) {
	/**
	 * Function that add sidebar meta boxes for team single module
	 */
	function greenpath_core_add_team_single_sidebar_meta_boxes( $page, $has_single ) {
	...
	add_action( 'greenpath_core_action_after_team_meta_box_map', 'greenpath_core_add_team_single_sidebar_meta_boxes', 10, 2 );
}
