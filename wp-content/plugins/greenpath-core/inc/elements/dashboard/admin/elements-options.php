...
if ( ! function_exists( 'greenpath_core_add_elements_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function greenpath_core_add_elements_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'elements',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Elements', 'greenpath-core' ),
				'description' => esc_html__( 'Global Elements Options', 'greenpath-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$label_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Label Styles', 'greenpath-core' ),
				)
			);
			...
			$input_fields_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Input Fields Styles', 'greenpath-core' ),
				)
			);
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Focus Color', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Focus Color', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Focus Color', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Styles', 'greenpath-core' ),
				)
			);
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Box Shadow', 'greenpath-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_simple_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Textual Styles', 'greenpath-core' ),
				)
			);
			...
			$slider_arrow_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Slider Arrow Styles', 'greenpath-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Left Icon SVG Path', 'greenpath-core' ),
					'description' => esc_html__( 'Enter your sliders arrow left icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'greenpath-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Right Icon SVG Path', 'greenpath-core' ),
					'description' => esc_html__( 'Enter your sliders arrow right icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'greenpath-core' ),
				)
			);
			...
			$slider_arrow_row = $slider_arrow_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Icon Styles', 'greenpath-core' ),
				)
			);
			...
			do_action( 'greenpath_core_action_after_elements_options_map', $page );
		}
	}

	add_action( 'greenpath_core_action_default_options_init', 'greenpath_core_add_elements_options' );
}
